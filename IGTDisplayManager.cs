...
namespace OUAK_IGT
{
    public static class IGTDisplayManager
    {
        ...
        private static TMP_FontAsset _cachedTimerFont;
        ...
        /// <summary>
        /// Gets and caches the game's CanvasScaler.
        /// </summary>
        ...
        /// <summary>
        /// Gets and caches the font asset used for the timer.
        /// </summary>
        private static TMP_FontAsset TimerFont
        {
            get
            {
                if (_cachedTimerFont == null)
                {
                    var tmpFonts = Resources.FindObjectsOfTypeAll<TMP_FontAsset>();
                    _cachedTimerFont = tmpFonts.FirstOrDefault(f => f != null && f.name == TIMER_FONT_NAME);

                    if (_cachedTimerFont == null)
                    {
                        _cachedTimerFont = tmpFonts.FirstOrDefault(f => f != null);
                        MelonLogger.Error($"[IGT] We rolled up a strange font: {_cachedTimerFont.name}");
                        ShowNotification("Font not found! Please report this bug to the Speedrun Discord.", 20);
                    }

                    MelonLogger.Msg($"[IGT] Using font: {_cachedTimerFont.name}");
                }

                return _cachedTimerFont;
            }
        }
        ...
        private static Vector2 ReferenceResolution =>
            GameCanvasScaler?.referenceResolution ?? new Vector2(1920, 1080);
        ...
        /// Returns the position used, clamping if neccesary.
        /// </summary>
        public static Vector2 CreateDisplay(float timerX, float timerY)
        {
            ...
            try
            {
                ...
                _notificationText = CreateNotificationUI(_canvasObject.transform, TimerFont);
        ...
        /// <summary>
        /// Ends the move operation and returns the final timer position for saving.
        /// </summary>
        ...
        /// </summary>
        /// <param name="state">The color state to apply, see <see cref="TimerColorState"/>.</param>
